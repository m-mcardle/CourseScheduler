...
export default function CourseSelectionPanel({ setCourses, allCourses, collisions, courses }) {
  ...
  return (
    <Grid className="selection-panel" container spacing={0} sx={{ minWidth: "500px", width: '30%', bgcolor : 'rgba(216,216,216)', borderTopRightRadius: 40, borderBottomRightRadius: 40, justifyContent: 'center', display: 'flex' }}>
      ...
      {courseKeys.map((courseKey) => {
        ...
        return (
          <Grid item xs={12} key={courseKey} style={{maxWidth: '97%', p: 1, height: "15%", borderRadius: 12.5, backgroundColor: (collides ? 'rgba(205, 50, 3, 0.26)' : '') }}>
